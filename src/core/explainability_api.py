...
app = FastAPI(title="Explainability API", description="APIs for explaining agent actions and environment transitions.")
...
@app.post("/explain/agent_action", response_model=ExplanationResponse, tags=["Explainability"])
...
@app.post("/explain/env_transition", response_model=ExplanationResponse, tags=["Explainability"])
