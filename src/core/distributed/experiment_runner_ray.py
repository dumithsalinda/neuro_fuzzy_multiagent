...
def run_distributed_experiments(agent_name, env_name, config, num_workers=2, episodes_per_worker=5):
    ...
    workers = [ExperimentWorker.remote(agent_cls, env_cls, config) for _ in range(num_workers)]
