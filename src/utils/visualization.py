...
def plot_agent_explanations(
    explanation_history,
    agent_names=None,
    title="Agent Explanations (Q-values or Rule Activations)",
):
...
def plot_communication_graph(
    messages_history, agent_count, title="Agent Communication Graph"
):
    G = nx.DiGraph()
...
def plot_rule_activations(
    rule_activations, rule_labels=None, agent_idx=0, title="Fuzzy Rule Activations"
):
    """
