...
def test_render_knowledge_table_handles_missing_attrs(monkeypatch):
    ...
    class DummySt:
        ...
        def warning(self, msg):
            assert "missing expected attributes" in msg
...
def test_render_batch_analytics_empty(monkeypatch):
    ...
    class DummySt:
        def warning(self, msg):
            assert "No batch experiment data" in msg
...
def test_render_group_decisions_log_handles_malformed(monkeypatch):
    ...
    class DummySt:
        ...
        def warning(self, msg):
            assert (
                "Malformed group decision" in msg
                or "missing expected attributes" in msg
            )
...
def test_render_advanced_metrics_empty(monkeypatch):
    class DummySt:
        def warning(self, msg):
            assert "No data for advanced metrics" in msg
